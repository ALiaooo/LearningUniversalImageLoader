 ...
 */
public class PhotoListUseMemoryCacheAdapter  extends BaseAdapter implements AbsListView.OnScrollListener{
    ...
    public PhotoListUseMemoryCacheAdapter(List<ImageInfo> imageInfos, ListView listView) {
